    ...
    <div className="main-layout-container">
      ...
      <aside className="layout-sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          {(userInfor?.user?.role === "employee") &&
          (
            <Link
              to="/employees"
              className={`nav-link ${checkActive("/employees")}`}
            >
              Manage Employee
            </Link>
          )}
          <Link
            to="/messages"
            className={`nav-link ${checkActive("/messages")}`}
          >
            Message
          </Link>
        </nav>
      ...
      <div className="layout-content-wrapper">
        ...
        <header className="layout-header">
          <div className="header-welcome">
            Xin chào, <span>{userInfor?.user?.userName || "Chủ cửa hàng"}</span> 👋
          </div>
